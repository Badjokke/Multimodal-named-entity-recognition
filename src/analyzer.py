...
def parse_args():
    ...
    parser.add_argument(
        "dataset",
        help="Dataset root. Directory must have direct children text_preprocessed and image_preprocessed!"
    )
...
if __name__ == "__main__":
    ...
    loader = JsonlDatasetLoader(input_path=dataset, lightweight=True)
