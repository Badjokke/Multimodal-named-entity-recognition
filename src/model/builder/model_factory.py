from transformers import AutoModelForCausalLM, AutoTokenizer, LlamaForTokenClassification, LlamaTokenizerFast
...
"""
def create_model(model_builder,model_name):
    return model_builder.from_pretrained(
        model_name,
        device_map="auto",
...
def create_quant_model_classifier(model_name, bnb):
